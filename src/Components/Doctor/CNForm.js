...
// const doctorEmail = location.state ? location.state.doctorDetails : '';
// // console.log("Doctor Email:", doctorEmail);


//   const [selectedPurpose, setSelectedPurpose] = useState({
//     code: "", // Initialize with an empty code
//     display: "" // Initialize with an empty display text
//   });
...
//       display: selectedPurposeObject ? selectedPurposeObject.display : "" // Set the display text based on the selected code
//     });
//   };
...
//   //       hiTypes: hiTypes
//   //         .filter((type) => formData[type.code]) // Filter out only the checked HI types
//   //         .map((type) => type.code), // Map to get only the codes of the checked HI types
//   //       permission: {
//   //         accessMode: "VIEW",
//   //         dateRange: {
//   //           from: fromDate,
//   //           to: toDate // Assuming this is today's date
//   //         },
...
//                     variant="outlined"
//                   />
//                   <Typography variant="subtitle1">HI Types</Typography>
//                   {hiTypes.map((type) => (
//                     <FormControlLabel
//                       key={type.code}
//                       control={
