          ...
          {doctorDetails && (
            <div className="flex flex-col text-2xl">
              <div className="flex mb-2 justify-start">
                ...
                <span className="flex justify-start">{doctorDetails.name}</span>
              </div>
              <div className="flex mb-2 justify-start">
                <span className="w-32 font-semibold flex justify-start">
                  DOB:
                </span>
                <span className="flex justify-start">{doctorDetails.dob}</span>
              </div>
              <div className="flex mb-2 justify-start">
                <span className="w-32 font-semibold flex justify-start">
                  Mobile:
                  ...
                  <>
                    {doctorDetails.status === true ? (
                      <button
                        ...
                        onClick={() =>
                          handleDeactivateDoctor(doctorDetails.email)
                        }
                      >
                        Deactivate
                      </button>
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleActivateDoctor(doctorDetails.email)
                        }
                      >
                        Activate
                      </button>
